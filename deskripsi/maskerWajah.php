...
<head>
    ...
    <title>SHOP. CO | Masker Wajah</title>
...
<body>  
    ...
    <div class="product-container">
        <div class="image-section">
            <img id="main-image" src="../foto/Masker Wajah.jpg" alt="Masker Wajah">
            <div class="thumbnail-section">
            <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Masker Wajah.jpg" alt="Masker Wajah" onclick="changeImage('../foto/Masker Wajah.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Masker 1.jpg" alt="Masker Wajah" onclick="changeImage('../foto/Masker 1.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Masker 2.jpg" alt="Masker Wajah" onclick="changeImage('../foto/Masker 2.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Masker 3.jpg" alt="Masker Wajah" onclick="changeImage('../foto/Masker 3.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Masker 4.jpg" alt="Masker Wajah" onclick="changeImage('../foto/Masker 4.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Masker 5.jpg" alt="Masker Wajah" onclick="changeImage('../foto/Masker 5.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Masker 6.jpg" alt="Masker Wajah" onclick="changeImage('../foto/Masker 6.jpg')">
                </div>
            </div>
        </div>
        <div class="details-section">
            ...
            <p class="price" id="product-price">Rp23.000</p>
            <p class="description">
                Masker organik Ohmyskin kini hadir dalam ukuran mini dengan 6 varian best seller: Matcha, Milk, Choco, Coffee, Avocado, dan Strawberry, masing-masing memiliki berbagai manfaat seperti mencerahkan, melembapkan, merelaksasi, hingga meremajakan kulit wajah—cocok untuk menjaga kulit tetap sehat dan glowing!
            </p>
            <label for="size-select">Pilih Varian</label>
            <select id="size-select">
                <option value="" data-price="23000">Pilih Varian</option>
                <option value="Milk" data-price="23000">MILK</option>
                <option value="Matcha" data-price="23000">MATCHA</option>
                <option value="Choco" data-price="23000">CHOCO</option>
                <option value="Coffee" data-price="23000">COFFEE</option>
                <option value="Avocado" data-price="23000">AVOCADO</option>
                <option value="Strawberry" data-price="23000">STRAWBERRY</option>
            </select>
            <form action="" id="product-form" method="POST">
                <input type="hidden" name="product_name" value="Masker Wajah">
                <input type="hidden" name="product_price" id="hidden-product-price" value="23000">
                <input type="hidden" name="product_image" value="../foto/Masker Wajah.jpg">
            ...
            <p class="meta">
                <strong>Kategori:</strong> Perawatan Kulit, Masker Organik, Kecantikan Alami, Perawatan Wajah Harian, Produk Skincare<br>
                <strong>Tagar:</strong> Masker Organik, Perawatan Kulit, Kulit Glowing, Masker Alami, Skincare Lokal
            </p>
        </div>
    </div>
    ...
    <div class="tab-content" id="description">
        <h1 class="product-title">Masker Organik Ohmyskin - Pilihan Terbaik untuk Kulit Glowing!</h1>
        <p>Masker organik Ohmyskin sekarang sudah hadir dalam ukuran mini untuk kamu yang ingin mencoba semua varian! Tersedia 6 varian unggulan: <strong>Matcha</strong>, <strong>Milk</strong>, <strong>Choco</strong>, <strong>Coffee</strong>, <strong>Avocado</strong>, dan <strong>Strawberry</strong>. Semua varian ini adalah <span class="highlight">best seller</span> dengan manfaat luar biasa yang banyak dicari orang. Jangan sampai kehabisan ya! 😘</p>
        <h2>Manfaat Utama dari Setiap Varian</h2>
        <h3>Varian Milk</h3>
        <ul class="features-list">
            <li>Mencerahkan kulit wajah</li>
            <li>Mengecangkan kulit wajah</li>
            <li>Menutrisi kulit wajah</li>
            <li>Membantu kulit tampak glowing</li>
            <li>Melembutkan kulit</li>
            <li>Meratakan tekstur wajah</li>
            <li>Mengangkat sel kulit mati</li>
        </ul>
        <h3>Varian Matcha</h3>
        <ul class="features-list">
            <li>Mengatasi jerawat dan beruntusan</li>
            <li>Meredakan pembengkakan jerawat</li>
            <li>Membantu mengeringkan beruntusan</li>
            <li>Mencerahkan wajah</li>
            <li>Mengecangkan kulit wajah</li>
            <li>Menutrisi kulit wajah</li>
            <li>Sebagai antioksidan</li>
            <li>Mengurangi minyak berlebih</li>
            <li>Membuat wajah glowing</li>
        ...
        <h3>Varian Coffee</h3>
        <ul class="features-list">
            <li>Memudarkan dark spot (bintik hitam)</li>
            <li>Mengangkat sel kulit mati</li>
            <li>Sebagai antioksidan</li>
            <li>Menyamarkan pori-pori</li>
            <li>Mencerahkan kulit wajah</li>
            <li>Melembabkan kulit wajah</li>
        </ul>
        <h3>Varian Avocado</h3>
        <ul class="features-list">
            <li>Menghidrasi kulit wajah</li>
            <li>Menambah kelembapan kulit wajah</li>
            <li>Menenangkan kulit wajah</li>
            <li>Sebagai antioksidan untuk menangkal radikal bebas</li>
        </ul>
        <h3>Varian Strawberry</h3>
        <ul class="features-list">
            <li>Membantu meremajakan kulit wajah</li>
            <li>Membantu memperbaiki skin barrier</li>
            <li>Menyamarkan garis halus di wajah</li>
            <li>Sebagai anti-inflamasi untuk mengatasi kemerahan</li>
            <li>Sebagai antioksidan untuk menangkal radikal bebas</li>
        </ul>
        <h3>Kenapa Harus Coba Masker Ohmyskin?</h3>
        <ul class="features-list">
            <li><strong>Natural dan Aman</strong>: Semua bahan alami dan cocok untuk semua jenis kulit.</li>
            <li><strong>Ukuran Praktis</strong>: Mini size yang mudah dibawa ke mana saja.</li>
            <li><strong>Manfaat Beragam</strong>: Dari mencerahkan hingga melembapkan kulit, semua kebutuhanmu terpenuhi.</li>
        </ul>
        <p><b>Manfaatnya luar biasa, kan?</b> Jangan tunggu lagi, rasakan kulit wajah yang lebih sehat, glowing, dan cantik alami dengan Masker Organik Ohmyskin! 😍</p>
    </div>
    <div class="tab-content" id="reviews" style="display: none;">
        <h3>Ulasan (<?= $review_count ?>)</h3>
        <?php if (isset($_SESSION['email'])): ?>
            <form id="review-form" action="/ppw/deskripsi/maskerWajah.php?product_id=<?= $product_id ?>" method="POST">
    ...
    <script>
        ...
        window.addEventListener('message', function (event) {
            ...
            if (event.data === 'checkoutComplete') {
                ...
                window.location.href = 'maskerWajah.php';
            }
        });
