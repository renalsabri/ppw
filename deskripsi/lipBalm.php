...
<body>  
    ...
    <div class="product-container">
        <div class="image-section">
            <img id="main-image" src="../foto/Lipbalm 1.jpg" alt="Lipbalm">
            <div class="thumbnail-section">
            <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Lipbalm 1.jpg" alt="Lipbalm" onclick="changeImage('../foto/Lipbalm 1.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Lipbalm 2.jpg" alt="Lipbalm" onclick="changeImage('../foto/Lipbalm 2.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Lipbalm 3.jpg" alt="Lipbalm" onclick="changeImage('../foto/Lipbalm 3.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Lipbalm 4.jpg" alt="Lipbalm" onclick="changeImage('../foto/Lipbalm 4.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Lipbalm 5.jpg" alt="Lipbalm" onclick="changeImage('../foto/Lipbalm 5.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Lipbalm 6.jpg" alt="Lipbalm" onclick="changeImage('../foto/Lipbalm 6.jpg')">
                </div>
            </div>
        </div>
        <div class="details-section">
            ...
            <p class="description">
                Lip Balm ini dirancang khusus untuk melindungi bibir dari paparan sinar matahari. Diformulasikan dengan bahan alami, lip balm ini memberikan kelembapan intensif sambil melindungi bibir dari UV. Aman dan lembut di bibir sensitif, menjadikannya pilihan ideal untuk perawatan bibir sepanjang hari.
            </p>
            <label for="size-select">Pilih Varian</label>
            <select id="size-select">
                <option value="" data-price="50000">Pilih Varian</option>
                <option value="Fruit Punch" data-price="50000">FRUIT PUNCH</option>
                <option value="Unflavoured" data-price="50000">UNFLAVOURED</option>
                <option value="Marie Regal" data-price="50000">MARIE REGAL</option>
                <option value="Strawberry" data-price="50000">STRAWBERRY</option>
                <option value="Cola" data-price="50000">COLA</option>
            </select>
            <form action="" id="product-form" method="POST">
                <input type="hidden" name="product_name" value="Lip Balm">
                <input type="hidden" name="product_price" id="hidden-product-price" value="50000">
                <input type="hidden" name="product_image" value="../foto/Lipbalm 1.jpg">
            ...
            <p class="meta">
                <strong>Kategori:</strong> Perawatan Bibir, Produk Perlindungan UV, Kosmetik Alami<br>
                <strong>Tagar:</strong> Lip Balm, Perawatan Bibir, UV Protection, Bibir Lembut, Produk Alami
            </p>
        </div>
    </div>
    ...
    <div class="tab-content" id="description">
        <h1 class="product-title">Lip Balm UV Protection</h1>
        <p>Baca deskripsi sampai habis dan pilih varian favoritmu untuk perawatan bibir yang lembut dan terlindungi!</p>
        <h3>Lip Balm UV Protection</h3>
        ...
        <ul class="features-list">
            <li>Melembapkan bibir dengan efektif, menjaga kelembapan sepanjang hari</li>
            <li>Melindungi bibir dari sinar UV</li>
            <li>Aman dan lembut di bibir sensitif</li>
            <li>Memberikan bibir yang halus dan sehat tanpa rasa lengket</li>
        </ul>
        <p>Dengan bahan alami, Lip Balm ini memberikan perlindungan ekstra untuk bibir dengan pilihan varian rasa yang menyegarkan dan aman digunakan setiap hari.</p>
        <h3>Kenapa Harus Pilih Lip Balm UV Protection?</h3>
        <ul class="features-list">
            <li><strong>Perlindungan UV:</strong> Melindungi bibir dari paparan sinar matahari.</li>
            <li><strong>Varian Lezat:</strong> Tersedia dalam berbagai rasa segar.</li>
            <li><strong>Aman & Lembut:</strong> Diformulasikan dengan bahan alami yang lembut di bibir sensitif.</li>
            <li><strong>Moisturizing:</strong> Menjaga kelembapan bibir dan mencegah bibir kering atau pecah-pecah.</li>
        </ul>
        <p><b>Jangan tunggu lagi!</b> Pilih varian favoritmu dan berikan perlindungan serta kelembapan terbaik untuk bibir. Dapatkan Lip Balm UV Protection sekarang juga! 💖</p>
    </div>
    <div class="tab-content" id="reviews" style="display: none;">
        <h3>Ulasan (<?= $review_count ?>)</h3>
        <?php if (isset($_SESSION['email'])): ?>
            <form id="review-form" action="/ppw/deskripsi/lipBalm.php?product_id=<?= $product_id ?>" method="POST">
    ...
    <script>
        ...
        window.addEventListener('message', function (event) {
            ...
            if (event.data === 'checkoutComplete') {
                ...
                window.location.href = 'lipBalm.php';
            }
        });
