...
<head>
    ...
    <title>SHOP. CO | T-Shirt Gojo Satoru</title>
...
<body>  
    ...
    <div class="product-container">
        <div class="image-section">
            <img id="main-image" src="../foto/Kaos Gojo.jpg" alt="Kaos Gojo">
            <div class="thumbnail-section">
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Kaos Gojo.jpg" alt="Kaos Gojo" onclick="changeImage('../foto/Kaos Gojo.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Kaos Gojo 2.jpg" alt="Kaos Gojo" onclick="changeImage('../foto/Kaos Gojo 2.jpg')">
                </div>
                <div class="thumbnail-wrapper">
                    <img class="thumbnail" src="../foto/Kaos Gojo 3.jpg" alt="Kaos Gojo" onclick="changeImage('../foto/Kaos Gojo 3.jpg')">
                </div>
            </div>
        </div>
        <div class="details-section">
            <h1>T-Shirt Gojo Satoru</h1>
            <div class="rating">★★★★★</div>
            <p class="price" id="product-price">Rp200.000</p>
            <p class="description">
                Kaos Gojo Satoru hadir dengan desain keren yang terinspirasi dari karakter ikonik dalam anime Jujutsu Kaisen. Dibuat dengan bahan berkualitas tinggi, kaos ini nyaman dipakai untuk aktivitas sehari-hari. Menampilkan gambar Gojo Satoru yang khas, dengan warna yang tegas dan detail yang menarik, cocok untuk para penggemar anime yang ingin menunjukkan kecintaannya pada karakter kuat dan karismatik ini. Tersedia dalam berbagai ukuran.
            </p>
            <label for="size-select">Pilih Ukuran</label>
            <select id="size-select">
                <option value="" data-price="200000">Pilih Ukuran</option>
                <option value="S" data-price="200000">S - Rp200.000</option>
                <option value="M" data-price="200000">M - Rp200.000</option>
                <option value="L" data-price="200000">L - Rp200.000</option>
                <option value="XL" data-price="200000">XL - Rp200.000</option>
                <option value="XXL" data-price="210000">XXL - Rp210.000</option>
                <option value="XXXL" data-price="215000">XXXL - Rp215.000</option>
                <option value="XXXXL" data-price="220000">XXXXL - Rp220.000</option>
            </select>
            <form action="" id="product-form" method="POST">
                <input type="hidden" name="product_name" value="T-Shirt Gojo Satoru">
                <input type="hidden" name="product_price" id="hidden-product-price" value="200000">
                <input type="hidden" name="product_image" value="../foto/Kaos Gojo.jpg">
            ...
            <p class="meta">
                <strong>Kategori:</strong> Fashion Anime, Kaos Karakter Anime, Pakaian Pria/Wanita, Merchandise Anime<br>
                <strong>Tagar:</strong> Gojo Satoru, Jujutsu Kaisen, Kaos Anime, Anime Merchandise, Fashion Anime
            </p>
        </div>
    </div>
    ...
    <div class="tab-content" id="description">
        <h1 class="product-title">T-Shirt Gojo Satoru - Tampil Keren dengan Karakter Ikonik!</h1>
        <p class="product-description">
            Tunjukkan kecintaan Anda pada anime Jujutsu Kaisen dengan <strong>Kaos Gojo Satoru</strong>. Dibuat dengan bahan berkualitas tinggi, kaos ini nyaman dipakai untuk sehari-hari, dengan desain yang menampilkan karakter Gojo Satoru yang ikonik dan penuh gaya. Cocok untuk penggemar anime yang ingin tampil beda dengan gaya kasual yang keren.
        </p>
        <h3>Fitur Utama:</h3>
        <ul class="features-list">
            <li><strong>Bahan Berkualitas</strong>: Material lembut, ringan, dan nyaman untuk dipakai sepanjang hari.</li>
            <li><strong>Desain Menarik</strong>: Menampilkan gambar Gojo Satoru yang khas dan detail yang tajam.</li>
            <li><strong>Ukuran Variatif</strong>: Tersedia dalam berbagai ukuran untuk semua penggemar anime.</li>
            <li><strong>Gaya Kasual</strong>: Cocok dipakai untuk hangout, acara anime, atau aktivitas santai lainnya.</li>
        </ul>
        <h3>Keunggulan:</h3>
        <ul class="features-list">
            <li><strong>Desain Ikonik</strong>: Gambar Gojo Satoru yang pasti dikenali oleh penggemar Jujutsu Kaisen.</li>
            <li><strong>Gaya Anime</strong>: Menambah kesan keren dan trendy bagi para penggemar anime.</li>
            <li><strong>Mudah Perawatan</strong>: Kaos yang mudah dicuci dan awet dipakai untuk jangka panjang.</li>
        </ul>
        <h3>Apa yang Kamu Dapat:</h3>
        <ul class="features-list">
            <li><strong>T-Shirt:</strong> Kaos Premium untuk kamu Fans Sejati Gojo Satoru.</li>
            <li><strong>Keychain:</strong> Gantungan kunci spesial untuk melengkapi koleksimu.</li>
            <li><strong>Box:</strong> Kemasan Box unik yang dicetak khusus dengan desain eksklusif ini.</li>
        </ul>
        <h3>Spesifikasi:</h3>
        <ul class="features-list">
            <li><strong>Warna Kain:</strong> Navy</li>
            <li><strong>Jenis Bahan:</strong> Cotton Combed 30s (Lembut dan tidak panas)</li>
            <li><strong>Jenis Sablon:</strong> MANUAL Plastisol Oilbased (Awet & tahan lama karena dikerjakan oleh profesional berpengalaman)</li>
            <li><strong>Ukuran Model Produk:</strong> Medium / M</li>
        </ul>
        <h3>Tips Perawatan:</h3>
        <ul class="features-list">
            <li>Cuci dengan air dingin untuk menjaga warna tetap cerah.</li>
            <li>Gunakan deterjen lembut dan hindari pemutih agar kaos tetap awet.</li>
            <li>Jemur di tempat teduh untuk mempertahankan kualitas bahan.</li>
        </ul>
    </div>
    <div class="tab-content" id="reviews" style="display: none;">
        <h3>Ulasan (<?= $review_count ?>)</h3>
        <?php if (isset($_SESSION['email'])): ?>
            <form id="review-form" action="/ppw/deskripsi/kaosGojo.php?product_id=<?= $product_id ?>" method="POST">
    ...
    <script>
        ...
        window.addEventListener('message', function (event) {
            ...
            if (event.data === 'checkoutComplete') {
                ...
                window.location.href = 'kaosGojo.php';
            }
        });
